 ...
 *  Versão C++ para Arduino IDE + Edge Impulse Arduino Library
 * ============================================================
 *
 *  Como usar:
...
// Necessário em arquivo .cpp, pois o Arduino IDE só gera
// protótipos automaticamente para arquivos .ino.
// ============================================================
